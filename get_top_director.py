...
# req1 = requests.get(f"https://www.the-numbers.com/box-office-star-records/worldwide/lifetime-specific-technical-role/director").text
# soup = BeautifulSoup(req1, "html5lib")
# table_body = soup.find_all('tbody')
# table_body_of_cast = table_body[3]
# table_row = table_body_of_cast.find_all('tr')
